...
// Full circle at center (110,110), r=90 — text flows clockwise from leftmost point
const CIRC_PATH = 'M 20,110 a 90,90 0 1,1 180,0 a 90,90 0 1,1 -180,0';
// Arch: very rounded top, gently rounded bottom
const ARCH = '50% 50% 30% 30% / 42% 42% 22% 22%';
    ...
    >
      ...
      <div className="flex-1 flex items-end">
        ...
        <div className="hidden md:flex items-end justify-center w-full max-w-5xl mx-auto px-6">
          ...
          {/* Oval 1 — dark, heading + circular stamp text */}
          <div
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center text-center px-8 gap-6">
              <h1
                className="font-serif font-bold text-white leading-[1.08] [text-wrap:balance]"
          ...
          {/* Oval 2 — warm gradient (the "texture" panel) */}
          <div
            ...
            style={{
              ...
              marginLeft: -62,
              borderRadius: ARCH,
              background: `radial-gradient(ellipse at 40% 30%, var(--lp-border) 0%, var(--lp-accent) 52%, var(--lp-primary) 100%)`,
              zIndex: 2,
              boxShadow: '0 0 0 4px var(--lp-bg-hero)',
            }}
          >
            <div
          ...
          >
            ...
            />
            <div
              className="absolute inset-x-0 bottom-0 pb-7 pt-16 px-6 text-center"
              style={{ background: 'linear-gradient(to top, rgba(0,0,0,0.58) 0%, transparent 100%)' }}
            >
        ...
        <div className="md:hidden w-full flex flex-col items-center px-5 pb-6">
          ...
          >
            ...
            <div
              ...
              style={{ background: 'linear-gradient(to top, rgba(0,0,0,0.72) 0%, rgba(0,0,0,0.08) 52%, transparent 100%)' }}
            >
              <h1
                className="font-serif font-bold text-white leading-[1.1] mb-5 [text-wrap:balance]"
