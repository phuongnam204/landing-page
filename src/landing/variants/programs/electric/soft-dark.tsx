...
export function ElectricSoftDarkPrograms({ suggestedPrograms, onContinue }: ProgramsSlotProps) {
  return (
    <div className="bg-[var(--lp-bg-payoff)] py-12 px-5">
        ...
        <div className="flex flex-col gap-4">
          {suggestedPrograms.map(sp => (
            <div
              ...
              style={{ background: 'var(--lp-bg-card)', border: '1px solid var(--lp-border)' }}
            >
