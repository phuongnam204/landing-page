...
export function ElectricSoftDarkConversion(props: ConversionSlotProps) {
  return (
    <div className="min-h-[100dvh] bg-[var(--lp-bg-minigame)] flex items-center justify-center py-12 px-5">
