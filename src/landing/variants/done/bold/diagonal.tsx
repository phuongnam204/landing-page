...
export function BoldDiagonalDone({ selectedProgramId }: DoneSlotProps) {
  return (
    <div className="min-h-[100dvh] w-full flex flex-col overflow-hidden">
      <div
        className="py-10 md:py-14 text-center px-5"
        style={{ background: 'var(--lp-band-bg)', color: 'var(--lp-band-text)' }}
      >
        <div className="flex items-center justify-center mb-4">
          <svg viewBox="0 0 48 48" className="w-14 h-14" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ color: 'var(--lp-band-accent)' }}>
