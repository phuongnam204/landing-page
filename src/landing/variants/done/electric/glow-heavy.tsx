...
export function ElectricGlowHeavyDone({ selectedProgramId }: DoneSlotProps) {
  return (
    <div className="min-h-[100dvh] bg-[var(--lp-bg-payoff)] flex items-center justify-center py-12 px-5">
      <div className="max-w-lg w-full animate-fade-in-up">
        <div className="text-center mb-6">
          <div className="flex items-center justify-center mb-3">
            <svg viewBox="0 0 48 48" className="w-12 h-12" style={{ filter: 'drop-shadow(0 0 16px rgba(219,39,119,.4))' }} fill="none" strokeLinecap="round" strokeLinejoin="round">
