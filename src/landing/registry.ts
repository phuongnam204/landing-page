...
import type { HookSlotProps, MinigameSlotProps, PayoffSlotProps, ProgramsSlotProps, ConversionSlotProps, SocialProofSlotProps, DoneSlotProps, ExternHandoffSlotProps, TeaserPayoffSlotProps, PathChooserSlotProps } from './slots';
...
export const registry = {
  ...
  expertHandoff: { 'natural-spa': NaturalSpaExpertHandoff } as Record<string, ComponentType<ExternHandoffSlotProps>>,
