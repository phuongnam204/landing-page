...
export const registry = {
  hook:        { 'two-column': TwoColumnHook, 'bold-single': BoldSingleHook, 'playful-classic': PlayfulClassicHook, 'playful-minimal': PlayfulMinimalHook, 'playful-immersive': PlayfulImmersiveHook, 'playful-immersive-photo': PlayfulImmersivePhotoHook, 'playful-classic-photo': PlayfulClassicPhotoHook, 'playful-dark-accent': PlayfulDarkAccentHook, 'clinical-classic': ClinicalClassicHook, 'clinical-compact': ClinicalCompactHook, 'clinical-dashboard': ClinicalDashboardHook, 'clinical-editorial': ClinicalEditorialHook, 'natural-classic': NaturalClassicHook, 'natural-spa': NaturalSpaHook, 'natural-editorial': NaturalEditorialHook, 'natural-minimal': NaturalMinimalHook, 'bold-classic': BoldClassicHook, 'bold-stacked': BoldStackedHook, 'bold-diagonal': BoldDiagonalHook, 'bold-typographic': BoldTypographicHook, 'face-dual': FaceDualHook, 'electric-classic': ElectricClassicHook, 'electric-glow-heavy': ElectricGlowHeavyHook, 'electric-soft-dark': ElectricSoftDarkHook, 'electric-light-pop': ElectricLightPopHook } as Record<string, ComponentType<HookSlotProps>>,
